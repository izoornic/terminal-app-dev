<div>
    <div class="py-6 flex flex-wrap">
        ...
        @if($is_admin)
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="p-6 bg-white overflow-hidden shadow-xl sm:rounded-lg h-96 w-96">
                <div class=""> 
                ...
                <div>
                    <x-jet-nav-link class="mt-4" href="{{ route( 'managment-distributeri' ) }}" :active="request()->routeIs('managment-distributeri')" >
