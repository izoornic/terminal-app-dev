                    ...
                    <table class="min-w-full divide-y divide-gray-200" style="width: 100% !important">
                        ...
                        {{-- SEARCH ROW --}}
                            ...
                            <tr class="bg-orange-50 border-dashed border-t-2 border-gray-300">
                                ...
                                <td></td>
                                <td>
                                    <x-jet-input wire:model.live="searchDodeljenIme" id="" class="block bg-orange-50 w-full" type="text" placeholder="Dodeljen" />
                                </td>
                                <td>
                ...
                @foreach ($this->searchTerminal() as $value)
                    <tr class="hover:bg-gray-100" wire:click="$set('newTerminalLokacijaId', {{ $value->id }})" >    
                            ...
                            <td>
                                ...
                                {{ $value->l_naziv}}&nbsp;{{ $value->l_naziv_sufix }}</td>
                            <td>{{ $value->mesto}}</td>
                    </tr>
                @endforeach
                </tbody>
