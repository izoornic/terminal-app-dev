<div class="p-6">
    ...
    <div class="flex items-center justify-between px-2 py-3 mb-6 bg-sky-100 border-t-4 border-sky-500 rounded-b text-sky-900 shadow-md">
        ...
        <p>Ukupan iznos: <span class="font-bold">@money($sum_zaduzenja) </span>RSD </p>
        </div>
        <div>
    ...
    <div class="px-4 py-3 flex sm:px-2 mt-20">
        <div class="ml-2 pr-2">
            <svg class="fill-red-400 w-6 h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path d="M64 32C28.7 32 0 60.7 0 96V416c0 35.3 28.7 64 64 64H384c35.3 0 64-28.7 64-64V96c0-35.3-28.7-64-64-64H64zm79 143c9.4-9.4 24.6-9.4 33.9 0l47 47 47-47c9.4-9.4 24.6-9.4 33.9 0s9.4 24.6 0 33.9l-47 47 47 47c9.4 9.4 9.4 24.6 0 33.9s-24.6 9.4-33.9 0l-47-47-47 47c-9.4 9.4-24.6 9.4-33.9 0s-9.4-24.6 0-33.9l47-47-47-47c-9.4-9.4-9.4-24.6 0-33.9z"/></svg>
        </div>
        <div class="font-bold"> NEZADUŽENE LICENCE</div>
    </div>
    <div class="flex flex-col">
        <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
            <div class="py-2 align-middle inline-block min-w-full sm:px-2 lg:px-8">
                    ...
                    <table class="min-w-full divide-y divide-gray-200" style="width: 100% !important">
                        <thead>
                            <tr>
                                ...
                                <th colspan=2 class="px-2 py-3 bg-gray-50 text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">Ukupno licenci: {{ $ndata->total() }}</th>
                                <th class="px-2 py-2 bg-gray-50 text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider"></th>
                            </tr>
                        </thead>
                        <tbody class="bg-white divide-y divide-gray-200">  
                        ...
                        {{-- DATA TABLE --}}    
                            ...
                            @else 
                                <tr>
                                    <td class="px-2 py-4 text-sm whitespace-no-wrap" colspan="4">Nisu pronađeni nenaplativi terminali</td>
                                </tr>
                            @endif
                        </tbody>
                    </table>
