...
<div class="p-6">
    <div class="flex items-center justify-end px-4 py-3 text-right sm:px-6">
        ...
        <x-jet-nav-link class="ml-4" href="{{ route( 'distributer-licence-grafik') }}" :active="request()->routeIs('distributer-licence-grafik')" title="Statistika licenci">
                    ...
                    <table class="min-w-full divide-y divide-gray-200" style="width: 100% !important">
                        <thead>
                            <tr>
                                ...
                                <th colspan="3" class="px-6 py-3 bg-gray-50 text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">Terminali</th>
                            ...
                            @if ($data->count())
                                @foreach ($data as $item)
                                    <tr>
                                        ...
                                        <td class="pl-1 pr-2">
                                            <x-jet-nav-link href="{{ route( 'distributer-licence-grafik', ['id' => $item->id] ) }}" :active="request()->routeIs('distributer-licence-grafik', ['id' => $item->id])" title="Statistika licenci">
                                            <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M4 4v15a1 1 0 0 0 1 1h15M8 16l2.5-5.5 3 3L17.273 7 20 9.667"/></svg>
                                            </x-jet-nav-link>
                                        </td>                                    
                                        <td>
