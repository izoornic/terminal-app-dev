<div class="relative bg-green-100 border-t-4 border-green-500 rounded-b text-green-900 px-4 py-3 shadow-md mb-6" role="alert">
   <div class="flex">
        ...
        <div>
            <div class="">
                <div>
                    <p>Naziv: <span class="font-bold">{{ $data->l_naziv }}&nbsp;{{ $data->l_naziv_sufix }}</span></p>
                    <p class="text-sm">PIB: <span class="font-bold">{{ $data->pib }}</span></p>
                    <p class="text-sm">Adresa: <span class="font-bold">{{$data->adresa}}</span></p>
                    <p class="text-sm">Mesto: <span class="font-bold">{{$data->mesto}}</span></p>
