                    ...
                    <table class="min-w-full divide-y divide-gray-200" style="width: 100% !important">
                        ...
                        {{-- SEARCH ROW --}}
                            <tr class="bg-orange-50">
                                ...
                                <td></td>
                                <td>
                                    <x-jet-input wire:model="searchNazivLokacije" id="" class="block bg-orange-50 w-full" type="text" placeholder="Naziv, Adresa, Mesto..." /> 
                                </td>
                                <td>
                                ...
                                <td>
                                    <select wire:model="searchTipLokacije" id="" class="block appearance-none bg-orange-50 w-full border border-0 text-gray-700 py-3 px-4 pr-8 round leading-tight focus:outline-none focus:bg-white focus:border-gray-500">
                                        <option value="">---</option>
                            ...
                            @if ($data->count())
                                @foreach ($data as $item)
                                    <tr @if($loop->even) class="bg-gray-50" @endif >
                                        ...
                                        <td class="px-1 py-1">
                                            <button class="text-sm text-gray-700 uppercase border rounded-md p-1.5 hover:bg-gray-700 hover:text-white" wire:click="premestiShowModal({{ $item->tlid }}, {{ $item->statusid }})">
                                                {{ __('Premesti') }}
                                            </button>
                                        </td>
                                        <td class="px-1 py-1">
