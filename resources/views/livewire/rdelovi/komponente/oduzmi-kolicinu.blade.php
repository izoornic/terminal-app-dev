<div>
    ...
    <div class="mt-4 form-group">
        <label for="kolicina">Oduzmi od stanja: </label>
        ...
        @if($oduzmimoguce == false)<span class="error">Izabrana količina je veća od trenutnog stanja</span> @endif
    </div>
    <hr class="my-4" />
    <div class="flex justify-center items-center">
        ...
        <button class="flex text-lg font-bold bg-sky-100 text-sky-900 uppercase border border-sky-900 rounded-md p-1.5 hover:bg-gray-700 hover:text-white" wire:click="save()">
          <x-heroicon-o-arrow-up-on-square-stack class="w-6 h-6"/>
            <span class="mx-2">Oduzmi od stanja</span>
        </button>
    </div>
</div>
