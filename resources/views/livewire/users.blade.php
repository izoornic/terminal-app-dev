<div class="p-6">
                    ...
                    <table class="min-w-full divide-y divide-gray-200" style="width: 100% !important">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">  
                            ...
                            <tr class="bg-orange-50">
                                ...
                                <td>
                                    <x-jet-input wire:model.live="searchName" id="" class="block bg-orange-50 w-full" type="text" placeholder="Pretrazi ime" />
                                </td>
                                <td>
                                    <x-jet-input wire:model.live="searchLokacija" id="" class="block bg-orange-50 w-full" type="text" placeholder="Lokacija" />
                                </td>
                                <td></td>
                                <td>
                                    <select wire:model.live="searchPozicija" id="" class="block appearance-none bg-orange-50 w-full border border-0 text-gray-700 py-3 px-4 pr-8 round leading-tight focus:outline-none focus:bg-white focus:border-gray-500">
                                            <option value="">---</option>
                                ...
                                <td>
                                    <select wire:model.live="searchRStatus" id="" class="block appearance-none bg-orange-50 w-full border border-0 text-gray-700 py-3 px-4 pr-8 round leading-tight focus:outline-none focus:bg-white focus:border-gray-500">
                                        <option value="">---</option>
    ...
    <x-jet-dialog-modal wire:model.live="modalFormVisible">
        ...
        <x-slot name="content">
            <div class="mt-4">
                ...
                <x-jet-input wire:model.live="name" id="" class="block mt-1 w-full" type="text" />
            ...
            @if (!$modelId) 
                ...
                <div class="mt-4">
                    ...
                    <x-jet-input wire:model.live="password" id="" class="block mt-1 w-full" type="text" />
            ...
            <div class="mt-4">
                ...
                <x-jet-input wire:model.live="telegramId" id="" class="block mt-1 w-full" type="text" />
            ...
            <div class="mt-4">
               ...
               <div class="mt-4 flex rounded-md shadow-sm">
                  ...
                  <input wire:model.live="tel" class="form-input flex-1 block w-full rounded-none rounded-r-md transition duration-150 ease-in-out sm:text-sm sm:leading-5" >
                  @error('tel') <span class="error">{{ $message }}</span>@enderror
               </div>
            </div> 
                 
            <div class="mt-4">
                @if(($modelId && $pozicijaId == 8) || isset($this->pozizicijeKategorije()[8]))
                    ...
                    <div class="flex items-center mt-4">
                        <label class="inline-flex items-center me-5 cursor-pointer">
                            <input type="checkbox" value="1" wire:model.live="vidi_komentare_na_terminalu" class="sr-only peer" >
                ...
                @else
                    ...
                    <select wire:model.live="pozicijaId" id="pozicija" class="block appearance-none w-full bg-gray-100 border border-gray-200 text-gray-700 py-3 px-4 pr-8 round leading-tight focus:outline-none focus:bg-white focus:border-gray-500">
            ...
            @elseif($selectedKatId == 4)
                ...
                <select wire:model.live="lokacijaId" id="lokacija" class="block appearance-none w-full bg-gray-100 border border-gray-200 text-gray-700 py-3 px-4 pr-8 round leading-tight focus:outline-none focus:bg-white focus:border-gray-500">
            ...
            <div class="mt-4">
                ...
                <select wire:model.live="radniOdnosId" id="radniodnos" class="block appearance-none w-full bg-gray-100 border border-gray-200 text-gray-700 py-3 px-4 pr-8 round leading-tight focus:outline-none focus:bg-white focus:border-gray-500">
    ...
    <x-jet-dialog-modal wire:model.live="modalRadniStatusVisible">
        <x-slot name="title">
        ...
        <x-slot name="content">          
            <div class="mt-4">
                ...
                <select wire:model.live="radniStatusId" id="" class="block appearance-none w-full bg-gray-100 border border-gray-200 text-gray-700 py-3 px-4 pr-8 round leading-tight focus:outline-none focus:bg-white focus:border-gray-500">
                    @foreach (App\Models\RadniStatusTip::userRadniStatusList() as $key => $value)    
                        <option value="{{ $key }}">{{ $value }}</option>
                    @endforeach
                </select>
