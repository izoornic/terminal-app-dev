                    ...
                    <table class="min-w-full divide-y divide-gray-200" style="width: 100% !important">
                        <thead>
                            <tr>
                                ...
                                <th class="px-1 py-3 bg-gray-50 text-left text-sm leading-4 font-medium text-gray-500"><x-heroicon-o-chat-bubble-left-right class="w-5 h-5" /></th>
                                <th class="px-1 py-3 bg-gray-50 text-left text-sm leading-4 font-medium text-gray-500">Prioritet</th>
                                <th class="px-1 py-3 bg-gray-50 text-left text-sm leading-4 font-medium text-gray-500">Ukupno: {{ $data_van_regiona->total() }}</th>
                        ...
                        <!-- SEARCH ROW -->
                            ...
                            @else 
                                <tr>
                                    <td class="px-6 py-4 text-sm whitespace-no-wrap bg-gray-100" colspan="4">No Results Found</td>
                                </tr>
                            @endif
                        </tbody>
                    </table>
