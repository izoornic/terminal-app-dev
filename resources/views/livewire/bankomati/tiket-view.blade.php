<div>
        ...
        <div class="bg-{{$prioritet->tr_bg_collor}} border-t-4 border-{{$prioritet->btn_collor}} rounded-b text-slate-600 px-4 py-3 shadow-md mb-6 mx-2 my-2" role="alert">
			<div class="flex justify-between"> 
							...
							<tr>
								...
								<td class="px-2">
                                    @if($userDodeljen)
                                        ...
                                        @if($tiket->status != "Zatvoren" && $user_pozicija_id != 11) 
				...
				<div>
                    ...
                    @if($user_pozicija_id == 9 && $tiket->status == "Zatvoren")
                        <div class="py-4">
    ...
    <x-jet-dialog-modal wire:model="modalDodeliTiketVisible">
        ...
        <x-slot name="content">
            @if($user_pozicija_id == 9 || $user_pozicija_id == 10)
            ...
            @else
                <div class="mt-4">Serviser doeljuje sebi</div>
            @endif
        </x-slot>
