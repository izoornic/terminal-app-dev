...
class DistributeriPregled extends Component
{
    ...
    public function read() 
    {
       ...
       return LicencaDistributerTip::select('licenca_distributer_tips.*')
            ...
            ->selectRaw('(SELECT COUNT(*) FROM licence_za_terminals WHERE licenca_distributer_tips.id = licence_za_terminals.distributerId AND licence_za_terminals.licenca_poreklo <> 2 AND naziv_licence = "esir") as broj_licenci_count')
